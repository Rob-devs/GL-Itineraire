...
public class Constants {
    ...
    // User preferences
    public static final String ITINARY_FASTEST = "Fastest";
    public static final String ITINARY_NO_CHANGE = "NoChange";
    ...
    // Application
    public static final int STATIONS_NEAR_USER = 3;
    public static final int MAX_ACCIDENT_STATION = 2;
    public static final int MAX_ACCIDENT_ROAD = 2;
}
